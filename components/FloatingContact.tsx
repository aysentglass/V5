  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed right-3 sm:right-5 bottom-20 sm:bottom-24 z-50 w-12 h-12 sm:w-14 sm:h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 hover:scale-110 transition-transform duration-300 group"
      ...
      <button
        ...
        className="fixed right-3 sm:right-5 bottom-36 sm:bottom-40 z-50 w-12 h-12 sm:w-14 sm:h-14 bg-[#07C160] rounded-full flex items-center justify-center shadow-lg hover:bg-[#06ad56] hover:scale-110 transition-transform duration-300"
        aria-label="WeChat"
      >
